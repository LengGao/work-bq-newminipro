...
function encrypt(word, key, iv) {
    // let keys,ivs
    // if(key){
    //      keys = CryptoJS.enc.Utf8.parse(key)
    //      ivs = CryptoJS.enc.Utf8.parse(iv)
    // }
    // console.log(keys,ivs)
    // var srcs = CryptoJS.enc.Utf8.parse(word);
    // var encrypted = CryptoJS.AES.encrypt(srcs, keys, { iv: ivs, mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7 });
...
function decrypt(word, key, iv) {
    ...
    var decrypt = CryptoJS.AES.decrypt(srcs, keys, { iv: ivs, mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7 });
